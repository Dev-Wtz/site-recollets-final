...
import { ChevronDown, ArrowLeft, Users, Languages, BookOpen, ExternalLink, Award, Menu, X } from 'lucide-react';
...
export default function CollegePage() {
  ...
  const niveaux = [
    { 
      ...
      classes: 5, 
      eleves: '≈ 30',
      langues: { lv1: 'Anglais, Allemand', lv2: null },
      options: ['Latin']
    },
    { 
      nom: '5ème', 
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[220px] z-50">
                    ...
                    <Link href="/structures/college" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors bg-[#8C1515] text-white">Collège</Link>
      ...
      {/* Section Collège avec animation de fondu */}
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          <div className="mb-16">
            <div className="relative w-full h-96 rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="/CollegeVueCour.png"
                alt="Collège des Récollets"
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-gray-50 rounded-xl p-8 shadow-lg">
              <h2 className="font-[var(--font-playfair)] text-3xl font-bold text-[#8C1515] mb-6">
                Un collège dynamique et moderne
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-4xl font-bold text-[#8C1515] mb-2">21</div>
              <div className="text-gray-600 font-[var(--font-inter)]">Classes</div>
            </div>
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              <Users className="w-12 h-12 text-[#8C1515] mx-auto mb-4" />
              <div className="text-4xl font-bold text-[#8C1515] mb-2">≈ 630</div>
            ...
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-gray-600 font-[var(--font-inter)]">Anglais, Allemand, Espagnol, Italien</div>
            </div>
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              <BookOpen className="w-12 h-12 text-[#8C1515] mx-auto mb-4" />
              <div className="text-lg font-semibold text-[#8C1515] mb-2">Latin</div>
              <div className="text-gray-600 font-[var(--font-inter)]">Option</div>
            </div>
          </div>
