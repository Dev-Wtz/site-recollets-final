...
export default function PrimairePage() {
  ...
  const niveaux = [
    { nom: 'CP', classes: 1, eleves: '≈ 25' },
    { nom: 'CE1', classes: 1, eleves: '≈ 25' },
    { nom: 'CE2', classes: 1, eleves: '≈ 25' },
    { nom: 'CM1', classes: 1, eleves: '≈ 25' },
    { nom: 'CM2', classes: 1, eleves: '≈ 25' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[220px] z-50">
                    ...
                    <Link href="/structures/primaire" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors bg-[#8C1515] text-white">Primaire</Link>
      ...
      {/* Section Primaire avec animation de fondu */}
        ...
        <div className="max-w-[1400px] mx-auto px-8">
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-lg">
              ...
              >
                <p className="font-[var(--font-inter)] text-base lg:text-lg leading-relaxed">
                  L&apos;école Notre Dame, située dans un environnement chaleureux, accueille les enfants du CP au CM2. Engagée dans un projet éducatif solide, elle vise non seulement l&apos;excellence académique, mais aussi la transmission de valeurs essentielles comme la fraternité et l&apos;ouverture à autrui.
                </p>
                <p className="font-[var(--font-inter)] text-base lg:text-lg leading-relaxed">
                  Grâce à une liberté pédagogique, l&apos;enseignement est adapté aux besoins de chaque élève, respectant leur rythme individuel. L&apos;établissement privilégie une approche holistique, encourageant les élèves à développer leurs talents, forger des relations solides et acquérir une conscience de leur environnement et des enjeux mondiaux.
                </p>
              </div>
              {needsShowMore && (
                <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-4xl font-bold text-[#8C1515] mb-2">5</div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                {niveaux.map((niveau, index) => (
                  <div key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow text-center">
