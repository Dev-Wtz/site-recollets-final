...
import { ChevronDown, ArrowLeft, Users, Languages, BookOpen, ExternalLink, Award, GraduationCap, Menu, X } from 'lucide-react';
...
export default function LyceeGeneralEtTechnologiquePage() {
  ...
  const niveaux = [
    { 
      ...
      classes: 4, 
      eleves: '≈ 30',
      langues: { lv1: 'Anglais, Allemand', lv2: 'Anglais, Allemand, Espagnol, Italien' },
      specialites: [],
      options: ['Management et Gestion', 'Sport', 'Arts Appliqué']
    },
    { 
      nom: '1ère', 
      classes: 4, 
      eleves: '≈ 30',
      langues: { lv1: 'Anglais, Allemand', lv2: 'Anglais, Allemand, Espagnol, Italien' },
      specialites: ['HGGSP', 'HLP', 'LLCE', 'Maths', 'PC', 'SVT', 'SES', 'NSI'],
      options: ['Sport', 'Arts Appliqué']
    },
    { 
      nom: '1ère STMG', 
      classes: 1, 
    ...
    { 
      ...
      langues: { lv1: 'Anglais, Allemand', lv2: 'Anglais, Allemand, Espagnol, Italien' },
      specialites: ['HGGSP', 'HLP', 'LLCE', 'Maths', 'PC', 'SVT', 'SES', 'NSI'],
      options: ['Sport', 'Arts Appliqué', 'Droit et grands enjeux du monde contemporain']
    },
    { 
      nom: 'Tle STMG', 
      classes: 1, 
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[220px] z-50">
                    ...
                    <Link href="/structures/lycee-general-et-technologique" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors bg-[#8C1515] text-white">Lycée Général et Technologique</Link>
      ...
      {/* Section Lycée Général et Technologique avec animation de fondu */}
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          <div className="mb-16">
            <div className="relative w-full h-96 rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="/Lycée.png"
                alt="Lycée Général et Technologique des Récollets"
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-gray-50 rounded-xl p-8 shadow-lg">
              <h2 className="font-[var(--font-playfair)] text-3xl font-bold text-[#8C1515] mb-6">
                Un environnement stimulant pour l&apos;excellence
              </h2>
              <div 
                ref={descriptionRef}
              ...
              >
                ...
                <p className="font-[var(--font-inter)] text-base lg:text-lg leading-relaxed">
                  Un suivi constant est assuré pour aider les élèves à acquérir autonomie, épanouissement personnel et ouverture aux autres. Une variété d&apos;options et de spécialités sont proposées à partir de la seconde année. Le lycée organise également des sorties et des voyages pédagogiques pour enrichir l&apos;expérience éducative.
                </p>
                <p className="font-[var(--font-inter)] text-base lg:text-lg leading-relaxed">
                  L&apos;engagement du personnel est centré sur le développement des compétences de chaque élève et leur préparation pour l&apos;avenir. Le Lycée des Récollets offre un environnement stimulant, un large choix de parcours et des expériences enrichissantes grâce à diverses sorties et voyages.
                </p>
              </div>
              {needsShowMore && (
                <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-4xl font-bold text-[#8C1515] mb-2">14</div>
              <div className="text-gray-600 font-[var(--font-inter)]">Classes</div>
            </div>
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              <Users className="w-12 h-12 text-[#8C1515] mx-auto mb-4" />
              <div className="text-4xl font-bold text-[#8C1515] mb-2">≈ 420</div>
              <div className="text-gray-600 font-[var(--font-inter)]">Élèves</div>
            </div>
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              <GraduationCap className="w-12 h-12 text-[#8C1515] mx-auto mb-4" />
              <div className="text-lg font-semibold text-[#8C1515] mb-2">8 Spécialités</div>
              <div className="text-gray-600 font-[var(--font-inter)] text-sm">HGGSP, HLP, LLCE, Maths, PC, SVT, SES, NSI</div>
            </div>
            <div className="bg-white border-2 border-[#8C1515] rounded-xl p-6 text-center shadow-lg">
              <Languages className="w-12 h-12 text-[#8C1515] mx-auto mb-4" />
              <div className="text-lg font-semibold text-[#8C1515] mb-2">4 Langues</div>
              <div className="text-gray-600 font-[var(--font-inter)] text-sm">Anglais, Allemand, Espagnol, Italien</div>
            </div>
          </div>
              ...
              {niveaux.map((niveau, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
                  ...
                  <div className="pt-4 border-t border-gray-200 space-y-3">
                    <div>
                      <span className="font-[var(--font-inter)] text-sm font-semibold text-gray-700">LV1 :</span>
                      <p className="font-[var(--font-inter)] text-sm text-gray-600">{niveau.langues.lv1}</p>
                    </div>
                    <div>
                      <span className="font-[var(--font-inter)] text-sm font-semibold text-gray-700">LV2 :</span>
                      <p className="font-[var(--font-inter)] text-sm text-gray-600">{niveau.langues.lv2}</p>
                    </div>
                    {niveau.specialites.length > 0 && (
                      <div>
                        <span className="font-[var(--font-inter)] text-sm font-semibold text-gray-700">Spécialités :</span>
                        <p className="font-[var(--font-inter)] text-sm text-gray-600">{niveau.specialites.join(', ')}</p>
                      </div>
                    )}
                    {niveau.options.length > 0 && (
                      <div>
                        <span className="font-[var(--font-inter)] text-sm font-semibold text-gray-700">Options :</span>
                        <p className="font-[var(--font-inter)] text-sm text-gray-600">{niveau.options.join(', ')}</p>
                      </div>
                    )}
                  </div>
                </div>
