...
export default function FournitureEcolePage() {  // Liste des classes de l'école
  ...
  const classes = [
    { code: 'PS', nom: 'Petite Section', fichier: 'FourniturePS ' }, // Note: espace dans le nom de fichier
  ...
  // État pour la classe sélectionnée (PS par défaut)
  const [classeSelectionnee, setClasseSelectionnee] = useState<string>('PS');
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="flex items-center justify-between h-14 relative">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[180px] z-50">
                    <Link href="/fournitures-scolaires/ecole" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors first:rounded-t-lg bg-[#8C1515] text-white">École</Link>
      ...
      {/* Section Fournitures Scolaires École avec animation de fondu */}
          ...
          <div className="mb-12">
            ...
            <div className="max-w-3xl mx-auto mb-12 text-center">
              <p className="font-[var(--font-inter)] text-base lg:text-lg text-gray-700 leading-relaxed mb-4">
                Retrouvez ci-dessous la liste des fournitures scolaires nécessaires pour chaque niveau de l'école. Ces listes vous permettront de préparer la rentrée scolaire dans les meilleures conditions.
              </p>
