...
export default function FournitureLyceeProPage() {  // Liste des classes du lycée professionnel
  ...
  const classes = [
    { code: 'SP', nom: 'Seconde Professionnelle', fichier: 'FournitureSP' },
    { code: 'PP', nom: 'Première Professionnelle', fichier: 'FourniturePP' },
    { code: 'TP', nom: 'Terminale Professionnelle', fichier: 'FournitureTP' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[180px] z-50">
                    ...
                    <Link href="/fournitures-scolaires/lycee-pro" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors last:rounded-b-lg bg-[#8C1515] text-white">Lycée Pro</Link>
                  </div>
                </div>
      ...
      {/* Section Fournitures Scolaires Lycée Pro avec animation de fondu */}
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="mb-12">
            <h2 className="font-[var(--font-playfair)] text-5xl lg:text-6xl font-bold text-[#8C1515] mb-6 text-center">
              Fournitures Scolaires - Lycée Professionnel
            </h2>
            ...
            <div className="max-w-3xl mx-auto mb-12 text-center">
              <p className="font-[var(--font-inter)] text-base lg:text-lg text-gray-700 leading-relaxed mb-4">
                Retrouvez ci-dessous la liste des fournitures scolaires nécessaires pour chaque niveau du lycée professionnel. Ces listes vous permettront de préparer la rentrée scolaire dans les meilleures conditions.
              </p>
