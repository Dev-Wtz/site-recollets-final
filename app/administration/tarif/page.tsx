...
export default function TarifPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[180px] z-50">
                    <Link href="/administration/tarif" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors first:rounded-t-lg bg-[#8C1515] text-white">Tarif</Link>
      ...
      {/* Section Tarifs avec animation de fondu */}
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#8C1515] text-white rounded-lg hover:bg-[#a01919] transition-colors font-[var(--font-inter)] font-semibold shadow-lg hover:shadow-xl"
            >
              <Download size={20} />
              Télécharger
            </a>
