...
export default function CantinePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[180px] z-50">
                    ...
                    <Link href="/restauration/cantine" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors bg-[#8C1515] text-white">Cantine</Link>
      ...
      {/* Section Restauration Cantine avec animation de fondu */}
      <section className="bg-white py-16 pt-32 animate-fade-in">
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="mb-12">
            ...
            {/* Texte descriptif sur la qualité */}
            <div className="max-w-3xl mx-auto mb-12 text-center">
              ...
              >
                <p className="font-[var(--font-inter)] text-base lg:text-lg text-gray-700 leading-relaxed mb-4">
                  Le restaurant scolaire des Récollets propose une restauration de qualité. Nos repas sont préparés quotidiennement sur place par notre équipe de restauration, garantissant qualité nutritionnelle.
                </p>
                <p className="font-[var(--font-inter)] text-base lg:text-lg text-gray-700 leading-relaxed mb-4">
                  Chaque menu est conçu pour répondre aux besoins énergétiques et nutritionnels des élèves, en privilégiant une alimentation équilibrée et variée. Nous accordons une attention particulière à la qualité des produits et au respect des normes d'hygiène et de sécurité alimentaire.
                </p>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              onClick={() => {
                ...
                link.href = '/MenuCantine.png';
                link.download = 'Menu-Cantine-Les-Recollets.png';
