              ...
              >
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white text-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[180px] z-50">
                    ...
                    <Link href="/restauration/cafeteria" className="block px-4 py-2.5 hover:bg-[#8C1515] hover:text-white transition-colors last:rounded-b-lg bg-[#8C1515] text-white">Cafétéria</Link>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto mb-12 text-center">
              ...
              >
                <p className="font-[var(--font-inter)] text-base lg:text-lg text-gray-700 leading-relaxed mb-4">
                  La cafétéria des Récollets offre un espace convivial où les élèves peuvent se restaurer avec des produits de qualité. Nous proposons une sélection variée de plats chauds, salades, sandwiches et desserts.
                </p>
                <p className="font-[var(--font-inter)] text-base lg:text-lg text-gray-700 leading-relaxed mb-4">
                  Notre équipe de restauration veille à proposer des options équilibrées et savoureuses. La cafétéria est un lieu de convivialité où les élèves peuvent se retrouver autour d'un repas de qualité.
                </p>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              onClick={() => {
                ...
                link.href = '/MenuCafeteria.png';
                link.download = 'Menu-Cafeteria-Les-Recollets.png';
